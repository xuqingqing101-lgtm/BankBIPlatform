...
-- 插入测试Pin项目
INSERT INTO panel_item (user_id, category, title, content, query_text, position_x, position_y, width, height, created_time) VALUES
(1, '存款业务', '本月存款增长情况', '本月存款增长850亿元，环比增长1.9%。对公存款增长520亿元，零售存款增长330亿元。', '本月存款增长情况如何？', 0, 0, 2, 1, CURRENT_TIMESTAMP),
(1, '贷款业务', '不良率分析', '当前不良率1.35%，较上月下降0.05个百分点。制造业不良率为2.1%，需要重点关注。', '当前不良率是多少？', 2, 0, 2, 1, CURRENT_TIMESTAMP),
(1, '客户业务', '高价值客户分析', 'VIP客户15,600户，AUM达到12.5万亿元，占总AUM的75%。', '高价值客户有多少？', 0, 1, 2, 1, CURRENT_TIMESTAMP);
